...
async def test_validate_access_client_registered_empty_roots(root_manager: RootManager):
    """Test validate_access returns True for a client registered with an empty list of roots."""
