...
class ComponentSecurityConfig:
    ...
    def get_enabled_tools(self) -> Dict[str, SecurityToolConfig]:
        ...
        return {
            name: config for name, config in self.security_tools.items()
            if config.enabled
        }
...
class SecurityConfig:
    ...
    def get_enabled_components(self) -> Dict[str, ComponentSecurityConfig]:
        ...
        return {
            comp_type: config for comp_type, config in self.components.items()
            if config.enabled
        }
...
def create_default_llm_config() -> ComponentSecurityConfig:
    ...
    llm_guard_config = SecurityToolConfig(
        ...
        config={
            "input_scanners": [
                "Anonymize", "BanTopics", "Code", "Language", 
                "PromptInjection", "Secrets", "TokenLimit", "Toxicity"
            ],
            "output_scanners": [
                "BanTopics", "Bias", "Code", "MaliciousURLs", 
