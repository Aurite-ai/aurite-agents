...
class OpenAIClient(BaseLLM):
    ...
    def __init__(
        ...
        logger.info(f"OpenAIClient initialized for model {self.model_name} using direct API calls.")
    ...
    async def create_message(
        ...
        logger.debug(f"Making OpenAI API call to model '{model_to_use}' with params: {request_params}")
