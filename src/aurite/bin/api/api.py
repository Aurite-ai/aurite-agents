...
from typing import Any, Callable, Dict, Optional  # Added List
    ...
    if openapi_file.exists():
        try:
            ...
            if isinstance(loaded_schema, dict):
                ...
                logger.warning(
                    f"OpenAPI schema from {openapi_file} is not a valid dictionary. Falling back."
                )
