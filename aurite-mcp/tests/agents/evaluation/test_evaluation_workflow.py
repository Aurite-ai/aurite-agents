    ...
    evaluation_results = [
        {
            ...
            "criterion_scores": {
                ...
                "relevance": {
                    "score": 4.5,
                    "justification": "Highly relevant to the task",
                },
            },
        ...
        },
        {
            ...
            "criterion_scores": {
                ...
                "relevance": {
                    "score": 4.0,
                    "justification": "Generally relevant to the task",
                },
            },
                        ...
                        text=json.dumps(
                            {
                                ...
                                "criterion_scores": {
                                    "accuracy": {
                                        "score": 4.0,
                                        "justification": "Very accurate analysis",
                                    },
                                    "relevance": {
                                        "score": 4.5,
                                        "justification": "Highly relevant to the task",
                                    ...
                                    "coherence": {
                                        "score": 4.0,
                                        "justification": "Well structured analysis",
                                    },
                                    "completeness": {
                                        "score": 4.3,
                                ...
                                "areas_for_improvement": [
                                    "Minor inaccuracies",
                                    "Could expand on recommendations",
                                ],
                            }
                        ),
                    )
                        ...
                        text=json.dumps(
                            {
                                ...
                                "criterion_scores": {
                                    "accuracy": {
                                        "score": 3.8 + score_variance,
                                        "justification": "Generally accurate",
                                    },
                                    "relevance": {
                                        "score": 4.2 + score_variance,
