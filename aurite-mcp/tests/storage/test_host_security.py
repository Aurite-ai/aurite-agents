...
from src.host.connection_manager import ConnectionManager

# Test configuration
SQL_SERVER_PATH = Path(__file__).parent.parent.parent / "src" / "storage" / "sql" / "sql_server.py"
    ...
    config = HostConfig(
        clients=[
            ClientConfig(
                ...
                roots=[RootConfig(name="sql", uri="sql:///", capabilities=["read", "write"])],
