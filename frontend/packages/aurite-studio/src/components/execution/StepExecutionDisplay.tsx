                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {isExecuting ? 'Executing...' : isCompleted ? `Completed` : 'Pending'}
                    </p>
                  </div>
                </div>
              ...
              {isExpanded && (isCompleted || isExecuting) && (
                ...
                >
                  <div className="p-4 space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <h5 className="text-sm font-medium">
                            Tool Calls ({completedStep.tool_calls.length}):
                          </h5>
                        </div>
                        <div className="space-y-2">
                    ...
                    {completedStep?.result?.conversation_history &&
                      completedStep.result.conversation_history.length > 0 && (
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <MessageSquare className="h-4 w-4 text-purple-500" />
                            <h5 className="text-sm font-medium">
                              Conversation History (
                              {completedStep.result.conversation_history.length} messages):
                            </h5>
                          </div>
                          <div className="max-h-40 overflow-y-auto space-y-2">
                            {completedStep.result.conversation_history.map(
