...
def test_llm_error_handling():
    ...
    try:
        ...
        if create_response.status_code == 200:
            ...
            # Now test it
            test_data = {
                "user_message": "Hello, this should fail",
                "system_prompt": "You are a helpful assistant."
            }
            
            test_response = requests.post(
                f"{base_url}/execution/llms/test_invalid_model/test",
                headers=headers,
                json=test_data
            )
            ...
            delete_response = requests.delete(
                f"{base_url}/config/components/llms/test_invalid_model",
                headers=headers
            )
    ...
    try:
        ...
        if create_response.status_code == 200:
            ...
            test_response = requests.post(
                f"{base_url}/execution/llms/test_empty_key/test",
                headers=headers,
                json=test_data
            )
            ...
            # Clean up
            delete_response = requests.delete(
                f"{base_url}/config/components/llms/test_empty_key",
                headers=headers
            )
            if delete_response.status_code == 200:
                print("   ✅ Cleaned up test LLM config")
    ...
    try:
        ...
        if create_response.status_code == 200:
            ...
            test_response = requests.post(
                f"{base_url}/execution/llms/test_invalid_provider/test",
                headers=headers,
                json=test_data
            )
            ...
            # Clean up
            delete_response = requests.delete(
                f"{base_url}/config/components/llms/test_invalid_provider",
                headers=headers
            )
            if delete_response.status_code == 200:
                print("   ✅ Cleaned up test LLM config")
    ...
    try:
        response = requests.post(
            f"{base_url}/execution/llms/my_openai_gpt4_turbo/test",
            headers=headers,
            json=test_data
        )
