...
class TestRunner:
    ...
    def run_fast_tests(self) -> Dict[str, Any]:
        ...
        cmd = [sys.executable, "-m", "pytest", "tests/unit/", "-v", "--tb=short", "-m", "not slow", "--timeout=10"]
    ...
    def run_integration_tests(self) -> Dict[str, Any]:
        ...
        cmd = [sys.executable, "-m", "pytest", "tests/integration/", "-v", "--tb=short", "--timeout=30", "--maxfail=5"]
    ...
    def run_smoke_tests(self) -> Dict[str, Any]:
        ...
        cmd = [sys.executable, "-m", "pytest", *smoke_tests, "-v", "--tb=short", "--timeout=15"]
